...
对上文进行补充：26春课改之后成绩构成&何嘉勇老师班部分评分标准
- 平时成绩（10%）
  - 缺勤或迟到一次（在点名之后到班）扣2分，累计次数达到当前学期1/3以上无期末分
- 身体素质（40%）
  - **马克操**，开学那几周会教，之后每节课的准备活动都会练习，注意动作连贯性，满分10分
  - **起跑器的使用**，满分10分
  - **1min俯卧撑**，3个1分，**不允许跪卧撑**，动作不标准不计数，满分10分
  - **立定跳远**，按照体测标准（大二标准），**可以用体测成绩代替**，满分10分
- 技术成绩（50%）
  - **50m**，按照体测标准（大二标准）折算成17分
  - **12min跑**，2km及格，记11分，多跑（少跑）100m加（扣）1分，满分17分
  - **1000m**，**可用体测成绩代替**，按照体测标准（大二标准）折算成16分

课改之后评分标准对体能不好的同学极其不友好，笔者所在教学班挂科率为6/31，不过挂科的同学考勤分普遍偏低，只要考勤分不低，老师都会捞一手的。因此，如果你不想挂科，**千万不要缺勤/迟到！** 另外，因故未参加体测的，或者对自己体测成绩不满意的，可以在最后一节课/何嘉勇老师带的其他课（体基，田径）进行1000m/立定跳远的补测
> 文 / JZWXZ，2026.7
